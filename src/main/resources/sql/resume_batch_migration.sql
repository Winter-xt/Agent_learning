CREATE TABLE IF NOT EXISTS resume_document (
    ...
    candidate_name_key VARCHAR(255) NOT NULL DEFAULT '',
    ...
    INDEX idx_resume_document_user_source (user_id_key(191), source_type),
    INDEX idx_resume_document_candidate (candidate_name),
    INDEX idx_resume_document_candidate_key (user_id_key(191), source_type, candidate_name_key(128))
);
